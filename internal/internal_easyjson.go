...
func easyjson2a877177DecodeGithubComPinptAgentNextGithubInternal7(in *jlexer.Lexer, out *repository) {
	...
	for !in.IsDelim('}') {
		...
		case "owner":
			easyjson2a877177Decode2(in, &out.Owner)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson2a877177EncodeGithubComPinptAgentNextGithubInternal7(out *jwriter.Writer, in repository) {
	...
	}
	{
		...
		out.RawString(prefix)
		easyjson2a877177Encode2(out, in.Owner)
	}
	out.RawByte('}')
}
...
func easyjson2a877177DecodeGithubComPinptAgentNextGithubInternal41(in *jlexer.Lexer, out *pullrequest) {
	...
	for !in.IsDelim('}') {
		...
		case "labels":
			easyjson2a877177Decode7(in, &out.Labels)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson2a877177EncodeGithubComPinptAgentNextGithubInternal41(out *jwriter.Writer, in pullrequest) {
	...
	}
	{
		const prefix string = ",\"labels\":"
		out.RawString(prefix)
		easyjson2a877177Encode7(out, in.Labels)
	}
	out.RawByte('}')
}
		...
		case "node":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson2a877177Decode8(in, &v37)
	...
	_ = first
	{
		...
		if in.Nodes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v38, v39 := range in.Nodes {
				...
				easyjson2a877177Encode8(out, v39)
			}
			out.RawByte(']')
		}
	}
